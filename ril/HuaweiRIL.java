...
public class HuaweiRIL extends RIL implements CommandsInterface {
 ...
 | sed -re 's/\{([^,]+),[^,]+,([^}]+).+/case \1: ret = \2(p); break;/'
            ...
            // case RIL_REQUEST_ENTER_DEPERSONALIZATION_CODE: ret =  responseInts(p); break; ==> not supported by MT7 -- gabry3795
            ...
            // case RIL_REQUEST_GET_DATA_CALL_PROFILE: ret =  responseGetDataCallProfile(p); break; ==> not supported by MT7 -- gabry3795
            ...
            // case RIL_REQUEST_SIM_GET_ATR: ret = responseString(p); break; ==> not supported by MT7 -- gabry3795
