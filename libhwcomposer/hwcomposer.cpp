...
#include <pthread.h>
#include <sys/ioctl.h>
#define LOG_TAG "Huawei Hisi HWC"
...
hwc_module_t HAL_MODULE_INFO_SYM = {
    .common = {
        ...
        .name = "Huawei Hisi HWComposer",
        .author = "Fell978 Development",
...
static int hwc_blank(struct hwc_composer_device_1* dev, int disp, int blank) {
	...
	ALOGE("Fell978: somehow the fd on %d was invalid while %s ?", disp, blank ? "banking" : "unblanking");
	return -EINVAL;
    }
